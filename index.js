...
mongoose.connect('mongodb+srv://quangdungnguyen147:1475369canhthin@cluster0.m8vkd.mongodb.net/Dung?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true}, function(err){
    if (err){
...
app.get("/weapon", controllerUser.weapon);
app.get("/char", controllerUser.char);
